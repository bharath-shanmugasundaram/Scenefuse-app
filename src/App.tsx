          ...
          {!video && (
            <div className="space-y-8">
              <div className="text-center space-y-4 py-12">
                <h1 className="text-4xl font-bold text-[#056cb8]">
...
function FeatureCard({ icon, title, description }: FeatureCardProps) {
  return (
    <div className="p-6 bg-blue-50 rounded-lg text-center border border-blue-100">
      <div className="w-12 h-12 bg-[#056cb8]/10 rounded-lg flex items-center justify-center mx-auto mb-4 text-[#056cb8]">
        {icon}
      </div>
      <h3 className="font-semibold text-[#056cb8] mb-2">{title}</h3>
      <p className="text-sm text-blue-900/60">{description}</p>
    </div>
  );
}
